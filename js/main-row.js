  ...
  overlay.innerHTML = `
    <div class="terms-sheet" role="dialog" aria-modal="true" aria-labelledby="termsTitle" tabindex="-1">
      ...
      <div class="terms-body" id="termsBody">
       한국위드케어협회는 상담 신청 및 서비스 제공을 위해 아래와 같이 개인정보를 수집·이용합니다.<br><br>

    1. 수집하는 개인정보 항목<br>
    - 필수항목 : 성함, 연락처, 지역, 건물 종류, 상담 가능 시간<br>
    - 선택항목 : 이메일, 문의사항<br><br>
    ...
    - 서비스 안내 및 일정 조율<br>
    - 문의사항에 대한 답변 제공<br>
    - 이메일 입력 시 이벤트, 혜택 및 서비스 정보 안내<br><br>

    3. 개인정보 보유 및 이용 기간<br>
    - 상담 완료 후 1년간 보관 후 파기합니다.<br>
    - 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관할 수 있습니다.<br><br>

    4. 개인정보 제공 및 위탁<br>
    - 한국위드케어협회는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다.<br>
    - 단, 서비스 제공을 위해 필요한 경우 관련 법령에 따라 위탁될 수 있습니다.<br><br>

    5. 동의 거부 권리 및 불이익<br>
    - 이용자는 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다.<br>
    - 단, 필수항목에 대한 동의를 거부할 경우 상담 신청이 제한될 수 있습니다.<br><br>

    6. 개인정보 보호 책임<br>
    - 한국위드케어협회는 개인정보 보호를 위해 관련 법령을 준수하며 안전하게 관리합니다.<br><br>
