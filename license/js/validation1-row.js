$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfeMXAcedBl_n8ZX_6OcduPztQqIFMJNqYW-0ixva4XJUYR3A/formResponse");
...
function maxLengthCheck(object){
 ...
 function lic_pick(){
    ...
    function form_check1(){
        ...
        // alert($('input[name="refer_url"]').val());
        // alert($('input[name="user_agent"]').val());
